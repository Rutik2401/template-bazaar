 ...
 *
 * The export API (`/api/export`) navigates a real headless Chrome here, waits
 * for the `data-print-ready` flag, then captures `page.pdf()` (vector,
 * selectable text) or `page.screenshot()` (HD PNG) at the template's natural
 * size. Because it re-uses the SAME Preview component + Tailwind + next/font as
 * the editor, the output is pixel-identical to the live preview — and Chrome
 * renders gradient `bg-clip-text` text natively, so no html2canvas workarounds.
 *
