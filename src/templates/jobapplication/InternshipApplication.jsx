...
export default function InternshipApplication({ values }) {
  ...
  return (
    ...
    >
      ...
      <header className="m-10 mb-0 flex items-center gap-5 rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-100">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 inline-flex items-center gap-2 rounded-full bg-indigo-50 px-3 py-1 text-[13px] font-semibold text-indigo-600">
      ...
      <div className="flex-1 px-10 pt-8">
        {/* ── Objective ───────────────────────────────────────────────── */}
        <section>
          <h2 className="text-[12px] font-bold uppercase tracking-[0.22em] text-indigo-500">
          ...
          {experience.length ? (
            <div className="mt-4 space-y-3">
              {experience.map((line, i) => (
                ...
                >
                  <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-indigo-50 text-[12px] font-bold text-indigo-600">
                    {i + 1}
                  </span>
      ...
      {/* ── Contact footer ────────────────────────────────────────────── */}
      <footer className="mt-8 flex items-center justify-between bg-slate-900 px-10 py-6 text-white">
        ...
        <span className="text-[12px] uppercase tracking-[0.28em] text-slate-400">
